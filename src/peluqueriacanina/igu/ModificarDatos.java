...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    Controladora control = null;// aqui figuraba la instancia . Controladora control = new Controladora(); como esta ahora es una buena practica
    int num_cliente; // agregamos num_cliente como parametro para modificar, editar
    Mascota masco;
    
    public ModificarDatos(int num_cliente) {
        control = new Controladora();// tenia comentado y al modificar lo de arriba descomente aqui
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        // Mensajito que salio todo correctamente cuando guardamos las modificaciones
        // llamamos a mostrar mensaje por lo tanto
        mostrarMensaje("Edicion realizada correctamente", "Info", "Edicion correcta");
        // para que me salga la tabla con la edicion hecha de los nuevos datos
    ...
    private void cargarDatos(int num_cliente) {
        // Busca los datos de masco los carga y trae
        ...
        // Aca busca los datos del combo de esta forma tanto los datos de masco
        //y los del combo(Alergico y Atencion_Especial )son los datos originales
    ...
    // Copiamos mostrar mensaje de ver datos
